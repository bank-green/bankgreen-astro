...
export const baseColorTokens = {
  ...
  bgInverse: colorTokens.sky[800],
  borderDefault: colorTokens.gray[200],
  borderFocus: colorTokens.green[500],
  borderHeavy: colorTokens.gray[300],
  borderHover: colorTokens.green[500],
  borderLight: colorTokens.gray[100],
  linkActive: colorTokens.green[500],
  linkDefault: colorTokens.green[600],
  linkHover: colorTokens.green[500],
  linkVisited: colorTokens.green[800],
  linkInverse: colorTokens.green[300],
  textDefault: colorTokens.gray[800],
  textHeadings: colorTokens.sky[800],
  textInverse: colorTokens.gray[0],
  textLight: colorTokens.gray[500],
}
...
export const statusColorTokens = {
  ...
  textSuccess: colorTokens.green[500],
