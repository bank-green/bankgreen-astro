...
export function JoinPage({ page }: Props) {
  ...
  const boldText = text2 ? prismic.asText(text2) : "Bank.Green was founded on the belief that banks have had an easy time from their customers for too long";
  const regularText = text3 ? prismic.asText(text3) : ". Mass movements will pull us out of the climate crisis – and they'll pull your bank out, too.";
