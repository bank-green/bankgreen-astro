      ...
      <article>
        <header>
          ...
          {text2 && text2.length > 0 ? (
            ...
            <p>
              ...
              <a href="/contact">tell us your bank's name</a>, we'll try to include it as soon as possible. In the
              meantime, we encourage you to consider contacting your bank to ask them whether they fund fossil fuels.
              But that's not all you can do. To take further positive action, keep on scrolling…
            </p>
          )}
        </header>
        ...
        <section>
          ...
          {text5 && text5.length > 0 ? (
            ...
            <p>
              Our mission is to encourage as many people as possible to take a stand - to refuse to let their money
              fuel environmental destruction any longer. Considering who you bank with, we think you probably agree.
        ...
        <section>
          {text6 && text6.length > 0 ? (
            ...
            <p>
              We can't say it better than environmentalist Bill McKibben: "Money is the oxygen on which the fire of
              global warming burns." But don't wait for the fire department to turn up – join us!
            </p>
          )}
