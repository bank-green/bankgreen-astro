import { TextInput, Select, Button, Checkbox, Stack, Group, Title, List } from '@mantine/core';
...
export function LeadGen({ primary, items = [], slice_type }: Props) {
  ...
  return (
    <section data-slice-type={slice_type} aria-labelledby="lead-gen-title">
      <Stack>
        <Title id="lead-gen-title" order={2}>{title}</Title>
